...
public class OdooActivity extends OdooCompatActivity {
    ...
    private void startApp(Bundle savedInstanceState) {
        ...
        setContentView(com.odoo.R.layout.odoo_activity);
                ...
                OdooUserObjectUpdater.showUpdater(this, new OdooUserObjectUpdater.OnUpdateFinish() {
                    ...
                    public void userObjectUpdateFail() {
                        Toast.makeText(OdooActivity.this, OResource.string(OdooActivity.this,
                                com.odoo.R.string.toast_something_gone_wrong), Toast.LENGTH_LONG).show();
                        finish();
                    }
                });
            }
    ...
    private void setupDrawer() {
        mDrawerLayout = (DrawerLayout) findViewById(com.odoo.R.id.drawer_layout);
        mDrawerToggle = new ActionBarDrawerToggle(this, mDrawerLayout, com.odoo.R.string.app_name, com.odoo.R.string.app_name) {

            @SuppressLint("RestrictedApi")
            @Override
            public void onDrawerClosed(View drawerView) {
                super.onDrawerClosed(drawerView);
                setTitle(getResources().getString(com.odoo.R.string.app_name));
            ...
            public void onDrawerOpened(View drawerView) {
                ...
                invalidateOptionsMenu();
                setTitle(com.odoo.R.string.app_name);
            }
        ...
        mDrawerLayout.setDrawerShadow(com.odoo.R.drawable.drawer_shadow, GravityCompat.START);
    ...
    private void setupDrawerBox() {
        mDrawerItemContainer = (LinearLayout) findViewById(com.odoo.R.id.drawerItemList);
        ...
        for (ODrawerItem item : items) {
            View view = LayoutInflater.from(this).
                    inflate((item.isGroupTitle()) ? com.odoo.R.layout.base_drawer_group_layout :
                            com.odoo.R.layout.base_drawer_menu_item, mDrawerItemContainer, false);
            view.setTag(item);
    ...
    private void setupAccountBox() {
        mDrawerAccountContainer = (LinearLayout) findViewById(com.odoo.R.id.accountList);
        View chosenAccountView = findViewById(com.odoo.R.id.drawerAccountView);
        ...
        ImageView avatar = (ImageView) chosenAccountView.findViewById(com.odoo.R.id.profile_image);
        TextView name = (TextView) chosenAccountView.findViewById(com.odoo.R.id.profile_name_text);
        TextView url = (TextView) chosenAccountView.findViewById(com.odoo.R.id.profile_url_text);
        ...
        if (accounts.size() > 0) {
            ...
            ImageView boxIndicator = (ImageView) findViewById(com.odoo.R.id.expand_account_box_indicator);
    ...
    private void accountBoxToggle() {
        ImageView boxIndicator = (ImageView) findViewById(com.odoo.R.id.expand_account_box_indicator);
        boxIndicator.setImageResource(mAccountBoxExpanded ? com.odoo.R.drawable.ic_drawer_accounts_collapse
                : com.odoo.R.drawable.ic_drawer_accounts_expand);
    ...
    private void populateAccountList(OUser me, List<OUser> accounts) {
        ...
        for (final OUser user : accounts) {
            if (!user.getAndroidName().equals(me.getAndroidName())) {
                View view = LayoutInflater.from(this).inflate(com.odoo.R.layout.base_drawer_account_item, mDrawerAccountContainer, false);
                ImageView avatar = (ImageView) view.findViewById(com.odoo.R.id.profile_image);
                if (!user.getAvatar().equals("false")) {
                    Bitmap img = BitmapUtils.getBitmapImage(this, user.getAvatar());
                    if (img != null)
                        avatar.setImageBitmap(img);
                }
                OControls.setText(view, com.odoo.R.id.profile_name_text, user.getName());
                OControls.setText(view, com.odoo.R.id.profile_url_text, user.getHost());
                                            ...
                                            public void onFail() {
                                                OAlert.showError(OdooActivity.this,
                                                        OResource.string(OdooActivity.this,
                                                                com.odoo.R.string.error_invalid_password));
                                            }
                                        }).show();
    ...
    private void accountListDefaultItems() {
        // Adding add account
        View view = generateView(OResource.string(this, com.odoo.R.string.label_drawer_account_add_account),
                com.odoo.R.drawable.ic_action_add);
        view.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        // Adding add account
        view = generateView(OResource.string(this, com.odoo.R.string.label_drawer_account_manage_accounts),
                com.odoo.R.drawable.ic_action_settings);
        view.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
    ...
    private View generateView(String title, int res_id) {
        View view = LayoutInflater.from(this).inflate(com.odoo.R.layout.base_drawer_account_item,
                mDrawerAccountContainer, false);
        OControls.setGone(view, com.odoo.R.id.profile_url_text);
        ImageView icon = (ImageView) view.findViewById(com.odoo.R.id.profile_image);
        icon.setImageResource(res_id);
        icon.setColorFilter(OResource.color(this, com.odoo.R.color.body_text_2));
        TextView name = (TextView) view.findViewById(com.odoo.R.id.profile_name_text);
    ...
    public void setHasActionBarSpinner(Boolean hasActionBarSpinner) {
        ...
        if (actionBar != null) {
            Spinner spinner = (Spinner) findViewById(com.odoo.R.id.spinner_nav);
    ...
    public Spinner getActionBarSpinner() {
        ...
        if (mHasActionBarSpinner) {
            spinner = (Spinner) findViewById(com.odoo.R.id.spinner_nav);
